...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($user && $password === $user['PASSWORD']) {
            ...
            $_SESSION['role']      = $user['ROLE']; // admin 또는 user
            
            // 역할에 따른 이동
            if ($user['ROLE'] === 'MANAGER') {
                header("Location: public/noti_summary.php");
            } else {
                header("Location: public/recv_noti_summary.php");
            }
            exit;
        } else {
...
<head>
    ...
    <link rel="icon" href="/qi/img/sch_qi_v_512.png"/>
